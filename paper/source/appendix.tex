...
All the apps presented in this paper work in a web browser that supports MathML.
...
The app has a small help menu accessible from the icon at the top left corner
